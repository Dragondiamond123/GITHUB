...
main(int argc, char *argv[])
{
  ...
  14:	8c058593          	addi	a1,a1,-1856 # 8d0 <malloc+0x106>
  18:	4509                	li	a0,2
  1a:	6d2000ef          	jal	6ec <fprintf>
    exit(1);
  1e:	4505                	li	a0,1
  ...
  42:	8aa58593          	addi	a1,a1,-1878 # 8e8 <malloc+0x11e>
  46:	4509                	li	a0,2
  48:	6a4000ef          	jal	6ec <fprintf>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 3c2:	54a50513          	addi	a0,a0,1354 # 908 <digits>
 3c6:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 660:	2acb8b93          	addi	s7,s7,684 # 908 <digits>
 ...
 6c2:	24290913          	addi	s2,s2,578 # 900 <malloc+0x136>
        for(; *s; s++)
