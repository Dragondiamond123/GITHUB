...
getcmd(char *buf, int nbuf)
{
  ...
  write(2, "$ ", 2);
      ...
      16:	1fe58593          	addi	a1,a1,510 # 1210 <malloc+0xfa>
      1a:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      58:	1cc58593          	addi	a1,a1,460 # 1220 <malloc+0x10a>
      5c:	4509                	li	a0,2
      5e:	7db000ef          	jal	1038 <fprintf>
  exit(1);
      62:	4505                	li	a0,1
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      86:	1a650513          	addi	a0,a0,422 # 1228 <malloc+0x112>
...
000000000000008e <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ae:	27e70713          	addi	a4,a4,638 # 1328 <malloc+0x212>
    ...
    panic("runcmd");
      ...
      c6:	16e50513          	addi	a0,a0,366 # 1230 <malloc+0x11a>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
      ...
      e0:	15c58593          	addi	a1,a1,348 # 1238 <malloc+0x122>
      e4:	4509                	li	a0,2
      e6:	753000ef          	jal	1038 <fprintf>
  exit(0);
      ea:	4501                	li	a0,0
    ...
    runcmd(rcmd->cmd);
     ...
     114:	13858593          	addi	a1,a1,312 # 1248 <malloc+0x132>
     118:	4509                	li	a0,2
     11a:	71f000ef          	jal	1038 <fprintf>
      exit(1);
     11e:	4505                	li	a0,1
    ...
    if(fork1() == 0){
     ...
     176:	0e650513          	addi	a0,a0,230 # 1258 <malloc+0x142>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     4d0:	db4a8a93          	addi	s5,s5,-588 # 1280 <malloc+0x16a>
  ...
  while(peek(ps, es, "<>")){
     ...
     4e2:	d8250513          	addi	a0,a0,-638 # 1260 <malloc+0x14a>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     59e:	cee60613          	addi	a2,a2,-786 # 1288 <malloc+0x172>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     5ce:	cdeb0b13          	addi	s6,s6,-802 # 12a8 <malloc+0x192>
  ...
  return ret;
     ...
     5f8:	c9c50513          	addi	a0,a0,-868 # 1290 <malloc+0x17a>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     64a:	c5250513          	addi	a0,a0,-942 # 1298 <malloc+0x182>
...
000000000000066c <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     688:	c2c60613          	addi	a2,a2,-980 # 12b0 <malloc+0x19a>
     68c:	85ce                	mv	a1,s3
     68e:	854a                	mv	a0,s2
...
00000000000006c6 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     6e4:	bd8a0a13          	addi	s4,s4,-1064 # 12b8 <malloc+0x1a2>
  ...
  if(peek(ps, es, ";")){
     ...
     70e:	bb660613          	addi	a2,a2,-1098 # 12c0 <malloc+0x1aa>
     712:	85ce                	mv	a1,s3
     714:	854a                	mv	a0,s2
...
000000000000074e <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     764:	b2860613          	addi	a2,a2,-1240 # 1288 <malloc+0x172>
  ...
  if(!peek(ps, es, ")"))
     ...
     788:	b5460613          	addi	a2,a2,-1196 # 12d8 <malloc+0x1c2>
     78c:	85ca                	mv	a1,s2
     78e:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("syntax - missing )");
     ...
     7ca:	b1a50513          	addi	a0,a0,-1254 # 12e0 <malloc+0x1ca>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     7f2:	b5270713          	addi	a4,a4,-1198 # 1340 <malloc+0x22a>
...
0000000000000852 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     87e:	99e60613          	addi	a2,a2,-1634 # 1218 <malloc+0x102>
     882:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     8ac:	a5058593          	addi	a1,a1,-1456 # 12f8 <malloc+0x1e2>
     8b0:	4509                	li	a0,2
     8b2:	786000ef          	jal	1038 <fprintf>
    panic("syntax");
     8b6:	00001517          	auipc	a0,0x1
     8ba:	9da50513          	addi	a0,a0,-1574 # 1290 <malloc+0x17a>
...
00000000000008c2 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     8da:	a3248493          	addi	s1,s1,-1486 # 1308 <malloc+0x1f2>
     8de:	4589                	li	a1,2
     8e0:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(cmd[0] == 'c' && cmd[1] == 'd' && cmd[2] == ' '){
     ...
     97e:	99658593          	addi	a1,a1,-1642 # 1310 <malloc+0x1fa>
     982:	4509                	li	a0,2
     984:	6b4000ef          	jal	1038 <fprintf>
...
printint(int fd, long long xx, int base, int sgn)
{
  ...
  if(sgn && xx < 0){
     ...
     cfa:	0805c963          	bltz	a1,d8c <printint+0xa0>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
     cfe:	2581                	sext.w	a1,a1
  neg = 0;
     d00:	4881                	li	a7,0
  ...
  do{
    buf[i++] = digits[x % base];
     d08:	2601                	sext.w	a2,a2
     d0a:	00000517          	auipc	a0,0x0
     d0e:	64e50513          	addi	a0,a0,1614 # 1358 <digits>
     d12:	883a                	mv	a6,a4
     d14:	2705                	addiw	a4,a4,1
     d16:	02c5f7bb          	remuw	a5,a1,a2
     d1a:	1782                	slli	a5,a5,0x20
     d1c:	9381                	srli	a5,a5,0x20
     d1e:	97aa                	add	a5,a5,a0
     d20:	0007c783          	lbu	a5,0(a5)
     d24:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
     d28:	0005879b          	sext.w	a5,a1
     d2c:	02c5d5bb          	divuw	a1,a1,a2
     d30:	0685                	addi	a3,a3,1
     d32:	fec7f0e3          	bgeu	a5,a2,d12 <printint+0x26>
  if(neg)
     d36:	00088c63          	beqz	a7,d4e <printint+0x62>
    buf[i++] = '-';
     d3a:	fd070793          	addi	a5,a4,-48
     d3e:	00878733          	add	a4,a5,s0
     d42:	02d00793          	li	a5,45
     d46:	fef70423          	sb	a5,-24(a4)
     d4a:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
     d4e:	02e05a63          	blez	a4,d82 <printint+0x96>
     d52:	f84a                	sd	s2,48(sp)
     d54:	f44e                	sd	s3,40(sp)
     d56:	fb840793          	addi	a5,s0,-72
     d5a:	00e78933          	add	s2,a5,a4
     d5e:	fff78993          	addi	s3,a5,-1
     d62:	99ba                	add	s3,s3,a4
     d64:	377d                	addiw	a4,a4,-1
     d66:	1702                	slli	a4,a4,0x20
     d68:	9301                	srli	a4,a4,0x20
     d6a:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
     d6e:	fff94583          	lbu	a1,-1(s2)
     d72:	8526                	mv	a0,s1
     d74:	f5bff0ef          	jal	cce <putc>
  while(--i >= 0)
     d78:	197d                	addi	s2,s2,-1
     d7a:	ff391ae3          	bne	s2,s3,d6e <printint+0x82>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     e92:	855a                	mv	a0,s6
     e94:	e3bff0ef          	jal	cce <putc>
        putc(fd, c0);
     e98:	85ca                	mv	a1,s2
     e9a:	855a                	mv	a0,s6
     e9c:	e33ff0ef          	jal	cce <putc>
      state = 0;
     ea0:	4981                	li	s3,0
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    100e:	31690913          	addi	s2,s2,790 # 1320 <malloc+0x20a>
        for(; *s; s++)
...
malloc(uint nbytes)
{
  ...
  if(p == SBRK_ERROR)
    ...
    117a:	f1278793          	addi	a5,a5,-238 # 2088 <base>
