...
ls(char *path)
{
  ...
  f8:	a1c50513          	addi	a0,a0,-1508 # b10 <malloc+0x128>
  fc:	039000ef          	jal	934 <printf>
      }
 ...
 122:	9c258593          	addi	a1,a1,-1598 # ae0 <malloc+0xf8>
 126:	4509                	li	a0,2
 128:	7e2000ef          	jal	90a <fprintf>
    return;
 12c:	bff9                	j	10a <ls+0x6e>
    fprintf(2, "ls: cannot stat %s\n", path);
 12e:	864a                	mv	a2,s2
 130:	00001597          	auipc	a1,0x1
 134:	9c858593          	addi	a1,a1,-1592 # af8 <malloc+0x110>
 138:	4509                	li	a0,2
 13a:	7d0000ef          	jal	90a <fprintf>
    close(fd);
 13e:	8526                	mv	a0,s1
 ...
 15e:	9c650513          	addi	a0,a0,-1594 # b20 <malloc+0x138>
 162:	7d2000ef          	jal	934 <printf>
      break;
 ...
 1a2:	972a0a13          	addi	s4,s4,-1678 # b10 <malloc+0x128>
        printf("ls: cannot stat %s\n", buf);
 1a6:	00001a97          	auipc	s5,0x1
 1aa:	952a8a93          	addi	s5,s5,-1710 # af8 <malloc+0x110>
    while(read(fd, &de, sizeof(de)) == sizeof(de)){
 1ae:	a031                	j	1ba <ls+0x11e>
        printf("ls: cannot stat %s\n", buf);
 1b0:	dc040593          	addi	a1,s0,-576
 1b4:	8556                	mv	a0,s5
 1b6:	77e000ef          	jal	934 <printf>
    while(read(fd, &de, sizeof(de)) == sizeof(de)){
 1ba:	4641                	li	a2,16
...
main(int argc, char *argv[])
{
 ...
 25e:	8de50513          	addi	a0,a0,-1826 # b38 <malloc+0x150>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 5e0:	56c50513          	addi	a0,a0,1388 # b48 <digits>
 5e4:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 87e:	2ceb8b93          	addi	s7,s7,718 # b48 <digits>
 ...
 8e0:	26490913          	addi	s2,s2,612 # b40 <malloc+0x158>
        for(; *s; s++)
...
malloc(uint nbytes)
{
 ...
 a4c:	5d878793          	addi	a5,a5,1496 # 2020 <base>
