...
go(int which_child)
{
  ...
  mkdir("grindir");
      ...
      8e:	0d650513          	addi	a0,a0,214 # 1160 <malloc+0x106>
      92:	349000ef          	jal	bda <mkdir>
  if(chdir("grindir") != 0){
      96:	00001517          	auipc	a0,0x1
      9a:	0ca50513          	addi	a0,a0,202 # 1160 <malloc+0x106>
    ...
    printf("grind: chdir grindir failed\n");
      ...
      b0:	0bc50513          	addi	a0,a0,188 # 1168 <malloc+0x10e>
      b4:	6f3000ef          	jal	fa6 <printf>
    exit(1);
      b8:	4505                	li	a0,1
  ...
  chdir("/");
      ...
      ca:	0ca50513          	addi	a0,a0,202 # 1190 <malloc+0x136>
      ce:	315000ef          	jal	be2 <chdir>
      d2:	00001997          	auipc	s3,0x1
      d6:	0ce98993          	addi	s3,s3,206 # 11a0 <malloc+0x146>
      da:	c489                	beqz	s1,e4 <go+0x70>
      dc:	00001997          	auipc	s3,0x1
      e0:	0bc98993          	addi	s3,s3,188 # 1198 <malloc+0x13e>
  uint64 iters = 0;
      e4:	4481                	li	s1,0
  int fd = -1;
      e6:	5a7d                	li	s4,-1
      e8:	00001917          	auipc	s2,0x1
      ec:	38890913          	addi	s2,s2,904 # 1470 <malloc+0x416>
    ...
    if(what == 1){
      ...
      fa:	0b250513          	addi	a0,a0,178 # 11a8 <malloc+0x14e>
    ...
    int what = rand() % 23;
     ...
     148:	07450513          	addi	a0,a0,116 # 11b8 <malloc+0x15e>
     ...
     15a:	05250513          	addi	a0,a0,82 # 11a8 <malloc+0x14e>
     15e:	265000ef          	jal	bc2 <unlink>
     162:	b755                	j	106 <go+0x92>
    } else if(what == 4){
      if(chdir("grindir") != 0){
     164:	00001517          	auipc	a0,0x1
     168:	ffc50513          	addi	a0,a0,-4 # 1160 <malloc+0x106>
     ...
     176:	05e50513          	addi	a0,a0,94 # 11d0 <malloc+0x176>
     17a:	249000ef          	jal	bc2 <unlink>
      chdir("/");
     17e:	00001517          	auipc	a0,0x1
     182:	01250513          	addi	a0,a0,18 # 1190 <malloc+0x136>
     186:	25d000ef          	jal	be2 <chdir>
     18a:	bfb5                	j	106 <go+0x92>
        printf("grind: chdir grindir failed\n");
     18c:	00001517          	auipc	a0,0x1
     190:	fdc50513          	addi	a0,a0,-36 # 1168 <malloc+0x10e>
     194:	613000ef          	jal	fa6 <printf>
        exit(1);
     198:	4505                	li	a0,1
     ...
     1ac:	03050513          	addi	a0,a0,48 # 11d8 <malloc+0x17e>
     ...
     1c6:	02650513          	addi	a0,a0,38 # 11e8 <malloc+0x18e>
     ...
     2b4:	fc050513          	addi	a0,a0,-64 # 1270 <malloc+0x216>
     2b8:	4ef000ef          	jal	fa6 <printf>
        exit(1);
     2bc:	4505                	li	a0,1
     ...
     2e6:	f8e50513          	addi	a0,a0,-114 # 1270 <malloc+0x216>
     2ea:	4bd000ef          	jal	fa6 <printf>
        exit(1);
     2ee:	4505                	li	a0,1
     ...
     32a:	f6a50513          	addi	a0,a0,-150 # 1290 <malloc+0x236>
     ...
     34a:	f4250513          	addi	a0,a0,-190 # 1288 <malloc+0x22e>
     ...
     360:	f1450513          	addi	a0,a0,-236 # 1270 <malloc+0x216>
     364:	443000ef          	jal	fa6 <printf>
        exit(1);
     368:	4505                	li	a0,1
     36a:	009000ef          	jal	b72 <exit>
        printf("grind: chdir failed\n");
     36e:	00001517          	auipc	a0,0x1
     372:	f3250513          	addi	a0,a0,-206 # 12a0 <malloc+0x246>
     376:	431000ef          	jal	fa6 <printf>
        exit(1);
     37a:	4505                	li	a0,1
     ...
     3a4:	ed050513          	addi	a0,a0,-304 # 1270 <malloc+0x216>
     3a8:	3ff000ef          	jal	fa6 <printf>
        exit(1);
     3ac:	4505                	li	a0,1
     ...
     3e4:	ed850513          	addi	a0,a0,-296 # 12b8 <malloc+0x25e>
     3e8:	3bf000ef          	jal	fa6 <printf>
        exit(1);
     3ec:	4505                	li	a0,1
     ...
     400:	ed458593          	addi	a1,a1,-300 # 12d0 <malloc+0x276>
     ...
     430:	eac50513          	addi	a0,a0,-340 # 12d8 <malloc+0x27e>
     434:	373000ef          	jal	fa6 <printf>
     438:	bfe9                	j	412 <go+0x39e>
          printf("grind: pipe read failed\n");
     43a:	00001517          	auipc	a0,0x1
     43e:	ebe50513          	addi	a0,a0,-322 # 12f8 <malloc+0x29e>
     442:	365000ef          	jal	fa6 <printf>
     446:	b7c5                	j	426 <go+0x3b2>
        printf("grind: fork failed\n");
     448:	00001517          	auipc	a0,0x1
     44c:	e2850513          	addi	a0,a0,-472 # 1270 <malloc+0x216>
     450:	357000ef          	jal	fa6 <printf>
        exit(1);
     454:	4505                	li	a0,1
     ...
     4c2:	db250513          	addi	a0,a0,-590 # 1270 <malloc+0x216>
     4c6:	2e1000ef          	jal	fa6 <printf>
        exit(1);
     4ca:	4505                	li	a0,1
     ...
     4d4:	e5050513          	addi	a0,a0,-432 # 1320 <malloc+0x2c6>
     ...
     4e4:	e4050513          	addi	a0,a0,-448 # 1320 <malloc+0x2c6>
     ...
     4f8:	ddc58593          	addi	a1,a1,-548 # 12d0 <malloc+0x276>
     ...
     532:	df250513          	addi	a0,a0,-526 # 1320 <malloc+0x2c6>
     536:	68c000ef          	jal	bc2 <unlink>
     53a:	b6f1                	j	106 <go+0x92>
        printf("grind: create c failed\n");
     53c:	00001517          	auipc	a0,0x1
     540:	dec50513          	addi	a0,a0,-532 # 1328 <malloc+0x2ce>
     544:	263000ef          	jal	fa6 <printf>
        exit(1);
     548:	4505                	li	a0,1
     54a:	628000ef          	jal	b72 <exit>
        printf("grind: write c failed\n");
     54e:	00001517          	auipc	a0,0x1
     552:	df250513          	addi	a0,a0,-526 # 1340 <malloc+0x2e6>
     556:	251000ef          	jal	fa6 <printf>
        exit(1);
     55a:	4505                	li	a0,1
     55c:	616000ef          	jal	b72 <exit>
        printf("grind: fstat failed\n");
     560:	00001517          	auipc	a0,0x1
     564:	df850513          	addi	a0,a0,-520 # 1358 <malloc+0x2fe>
     568:	23f000ef          	jal	fa6 <printf>
        exit(1);
     56c:	4505                	li	a0,1
     ...
     578:	dfc50513          	addi	a0,a0,-516 # 1370 <malloc+0x316>
     57c:	22b000ef          	jal	fa6 <printf>
        exit(1);
     580:	4505                	li	a0,1
     582:	5f0000ef          	jal	b72 <exit>
        printf("grind: fstat reports crazy i-number %d\n", st.ino);
     586:	00001517          	auipc	a0,0x1
     58a:	e1250513          	addi	a0,a0,-494 # 1398 <malloc+0x33e>
     58e:	219000ef          	jal	fa6 <printf>
        exit(1);
     592:	4505                	li	a0,1
     ...
     636:	e0658593          	addi	a1,a1,-506 # 1438 <malloc+0x3de>
     ...
     656:	dee50513          	addi	a0,a0,-530 # 1440 <malloc+0x3e6>
     65a:	14d000ef          	jal	fa6 <printf>
        exit(1);
     65e:	4505                	li	a0,1
     660:	512000ef          	jal	b72 <exit>
        fprintf(2, "grind: pipe failed\n");
     664:	00001597          	auipc	a1,0x1
     668:	c5458593          	addi	a1,a1,-940 # 12b8 <malloc+0x25e>
     66c:	4509                	li	a0,2
     66e:	10f000ef          	jal	f7c <fprintf>
        exit(1);
     672:	4505                	li	a0,1
     674:	4fe000ef          	jal	b72 <exit>
        fprintf(2, "grind: pipe failed\n");
     678:	00001597          	auipc	a1,0x1
     67c:	c4058593          	addi	a1,a1,-960 # 12b8 <malloc+0x25e>
     680:	4509                	li	a0,2
     682:	0fb000ef          	jal	f7c <fprintf>
        exit(1);
     686:	4505                	li	a0,1
     ...
     6bc:	d0858593          	addi	a1,a1,-760 # 13c0 <malloc+0x366>
     6c0:	4509                	li	a0,2
     6c2:	0bb000ef          	jal	f7c <fprintf>
          exit(1);
     6c6:	4505                	li	a0,1
     ...
     6d8:	d0478793          	addi	a5,a5,-764 # 13d8 <malloc+0x37e>
     6dc:	faf43423          	sd	a5,-88(s0)
     6e0:	00001797          	auipc	a5,0x1
     6e4:	d0078793          	addi	a5,a5,-768 # 13e0 <malloc+0x386>
     6e8:	faf43823          	sd	a5,-80(s0)
     6ec:	fa043c23          	sd	zero,-72(s0)
        exec("grindir/../echo", args);
     6f0:	fa840593          	addi	a1,s0,-88
     6f4:	00001517          	auipc	a0,0x1
     6f8:	cf450513          	addi	a0,a0,-780 # 13e8 <malloc+0x38e>
     6fc:	4ae000ef          	jal	baa <exec>
        fprintf(2, "grind: echo: not found\n");
     700:	00001597          	auipc	a1,0x1
     704:	cf858593          	addi	a1,a1,-776 # 13f8 <malloc+0x39e>
     708:	4509                	li	a0,2
     70a:	073000ef          	jal	f7c <fprintf>
        exit(2);
     70e:	4509                	li	a0,2
     710:	462000ef          	jal	b72 <exit>
        fprintf(2, "grind: fork failed\n");
     714:	00001597          	auipc	a1,0x1
     718:	b5c58593          	addi	a1,a1,-1188 # 1270 <malloc+0x216>
     71c:	4509                	li	a0,2
     71e:	05f000ef          	jal	f7c <fprintf>
        exit(3);
     722:	450d                	li	a0,3
     ...
     74c:	c7858593          	addi	a1,a1,-904 # 13c0 <malloc+0x366>
     750:	4509                	li	a0,2
     752:	02b000ef          	jal	f7c <fprintf>
          exit(4);
     756:	4511                	li	a0,4
     ...
     77c:	c4858593          	addi	a1,a1,-952 # 13c0 <malloc+0x366>
     780:	4509                	li	a0,2
     782:	7fa000ef          	jal	f7c <fprintf>
          exit(5);
     786:	4515                	li	a0,5
     ...
     798:	c7c78793          	addi	a5,a5,-900 # 1410 <malloc+0x3b6>
     79c:	faf43423          	sd	a5,-88(s0)
     7a0:	fa043823          	sd	zero,-80(s0)
        exec("/cat", args);
     7a4:	fa840593          	addi	a1,s0,-88
     7a8:	00001517          	auipc	a0,0x1
     7ac:	c7050513          	addi	a0,a0,-912 # 1418 <malloc+0x3be>
     7b0:	3fa000ef          	jal	baa <exec>
        fprintf(2, "grind: cat: not found\n");
     7b4:	00001597          	auipc	a1,0x1
     7b8:	c6c58593          	addi	a1,a1,-916 # 1420 <malloc+0x3c6>
     7bc:	4509                	li	a0,2
     7be:	7be000ef          	jal	f7c <fprintf>
        exit(6);
     7c2:	4519                	li	a0,6
     7c4:	3ae000ef          	jal	b72 <exit>
        fprintf(2, "grind: fork failed\n");
     7c8:	00001597          	auipc	a1,0x1
     7cc:	aa858593          	addi	a1,a1,-1368 # 1270 <malloc+0x216>
     7d0:	4509                	li	a0,2
     7d2:	7aa000ef          	jal	f7c <fprintf>
        exit(7);
     7d6:	451d                	li	a0,7
...
iter()
{
  ...
  unlink("a");
     ...
     7e8:	aa450513          	addi	a0,a0,-1372 # 1288 <malloc+0x22e>
     7ec:	3d6000ef          	jal	bc2 <unlink>
  unlink("b");
     7f0:	00001517          	auipc	a0,0x1
     7f4:	a4850513          	addi	a0,a0,-1464 # 1238 <malloc+0x1de>
  ...
  if(pid1 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     82a:	a4a50513          	addi	a0,a0,-1462 # 1270 <malloc+0x216>
     82e:	778000ef          	jal	fa6 <printf>
    exit(1);
     832:	4505                	li	a0,1
  ...
  if(pid2 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     864:	a1050513          	addi	a0,a0,-1520 # 1270 <malloc+0x216>
     868:	73e000ef          	jal	fa6 <printf>
    exit(1);
     86c:	4505                	li	a0,1
...
printint(int fd, long long xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     c52:	88250513          	addi	a0,a0,-1918 # 14d0 <digits>
     c56:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
     ...
     ce6:	28090663          	beqz	s2,f72 <vprintf+0x29a>
  ...
  for(i = 0; fmt[i]; i++){
     ...
     d2e:	22090a63          	beqz	s2,f62 <vprintf+0x28a>
    c0 = fmt[i] & 0xff;
    ...
    if(state == 0){
     ...
     d50:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
     d54:	05878363          	beq	a5,s8,d9a <vprintf+0xc2>
      } else if(c0 == 'l' && c1 == 'd'){
     d58:	05978d63          	beq	a5,s9,db2 <vprintf+0xda>
     ...
     d60:	0ee78763          	beq	a5,a4,e4e <vprintf+0x176>
     ...
     d68:	12e78963          	beq	a5,a4,e9a <vprintf+0x1c2>
     ...
     d70:	14e78e63          	beq	a5,a4,ecc <vprintf+0x1f4>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 'c'){
     d74:	06300713          	li	a4,99
     d78:	18e78e63          	beq	a5,a4,f14 <vprintf+0x23c>
        putc(fd, va_arg(ap, uint32));
      } else if(c0 == 's'){
     d7c:	07300713          	li	a4,115
     d80:	1ae78463          	beq	a5,a4,f28 <vprintf+0x250>
        if((s = va_arg(ap, char*)) == 0)
          s = "(null)";
        for(; *s; s++)
          putc(fd, *s);
      } else if(c0 == '%'){
     d84:	02500713          	li	a4,37
     d88:	04e79563          	bne	a5,a4,dd2 <vprintf+0xfa>
        putc(fd, '%');
     d8c:	02500593          	li	a1,37
     d90:	855a                	mv	a0,s6
     d92:	e81ff0ef          	jal	c12 <putc>
     ...
     da6:	855a                	mv	a0,s6
     da8:	e89ff0ef          	jal	c30 <printint>
     dac:	8bca                	mv	s7,s2
      state = 0;
     dae:	4981                	li	s3,0
     db0:	bf8d                	j	d22 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'd'){
     db2:	06400793          	li	a5,100
     db6:	02f68963          	beq	a3,a5,de8 <vprintf+0x110>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
     dba:	06c00793          	li	a5,108
     dbe:	04f68263          	beq	a3,a5,e02 <vprintf+0x12a>
      } else if(c0 == 'l' && c1 == 'u'){
     dc2:	07500793          	li	a5,117
     dc6:	0af68063          	beq	a3,a5,e66 <vprintf+0x18e>
      } else if(c0 == 'l' && c1 == 'x'){
     dca:	07800793          	li	a5,120
     dce:	0ef68263          	beq	a3,a5,eb2 <vprintf+0x1da>
        putc(fd, '%');
     dd2:	02500593          	li	a1,37
     dd6:	855a                	mv	a0,s6
     dd8:	e3bff0ef          	jal	c12 <putc>
        putc(fd, c0);
     ddc:	85ca                	mv	a1,s2
     dde:	855a                	mv	a0,s6
     de0:	e33ff0ef          	jal	c12 <putc>
      state = 0;
     de4:	4981                	li	s3,0
     de6:	bf35                	j	d22 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 1);
     ...
     dfe:	4981                	li	s3,0
        i += 1;
     e00:	b70d                	j	d22 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
     e02:	06400793          	li	a5,100
     e06:	02f60763          	beq	a2,a5,e34 <vprintf+0x15c>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
     e0a:	07500793          	li	a5,117
     e0e:	06f60963          	beq	a2,a5,e80 <vprintf+0x1a8>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
     e12:	07800793          	li	a5,120
     e16:	faf61ee3          	bne	a2,a5,dd2 <vprintf+0xfa>
        printint(fd, va_arg(ap, uint64), 16, 0);
     e1a:	008b8913          	addi	s2,s7,8
     e1e:	4681                	li	a3,0
     e20:	4641                	li	a2,16
     e22:	000bb583          	ld	a1,0(s7)
     e26:	855a                	mv	a0,s6
     e28:	e09ff0ef          	jal	c30 <printint>
        i += 2;
     e2c:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 16, 0);
     e2e:	8bca                	mv	s7,s2
      state = 0;
     e30:	4981                	li	s3,0
        i += 2;
     e32:	bdc5                	j	d22 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 1);
     ...
     e40:	855a                	mv	a0,s6
     e42:	defff0ef          	jal	c30 <printint>
        i += 2;
     e46:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 10, 1);
     e48:	8bca                	mv	s7,s2
      state = 0;
     e4a:	4981                	li	s3,0
        i += 2;
     e4c:	bdd9                	j	d22 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint32), 10, 0);
     e4e:	008b8913          	addi	s2,s7,8
     e52:	4681                	li	a3,0
     e54:	4629                	li	a2,10
     e56:	000be583          	lwu	a1,0(s7)
     e5a:	855a                	mv	a0,s6
     e5c:	dd5ff0ef          	jal	c30 <printint>
     e60:	8bca                	mv	s7,s2
      state = 0;
     e62:	4981                	li	s3,0
     e64:	bd7d                	j	d22 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 0);
     e66:	008b8913          	addi	s2,s7,8
     e6a:	4681                	li	a3,0
     e6c:	4629                	li	a2,10
     e6e:	000bb583          	ld	a1,0(s7)
     e72:	855a                	mv	a0,s6
     e74:	dbdff0ef          	jal	c30 <printint>
        i += 1;
     ...
     e8c:	855a                	mv	a0,s6
     e8e:	da3ff0ef          	jal	c30 <printint>
        i += 2;
     e92:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 10, 0);
     e94:	8bca                	mv	s7,s2
      state = 0;
     e96:	4981                	li	s3,0
        i += 2;
     e98:	b569                	j	d22 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint32), 16, 0);
     e9a:	008b8913          	addi	s2,s7,8
     e9e:	4681                	li	a3,0
     ea0:	4641                	li	a2,16
     ea2:	000be583          	lwu	a1,0(s7)
     ea6:	855a                	mv	a0,s6
     ea8:	d89ff0ef          	jal	c30 <printint>
     eac:	8bca                	mv	s7,s2
      state = 0;
     eae:	4981                	li	s3,0
     eb0:	bd8d                	j	d22 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 16, 0);
     ...
     ec8:	4981                	li	s3,0
        i += 1;
     eca:	bda1                	j	d22 <vprintf+0x4a>
     ecc:	e06a                	sd	s10,0(sp)
        printptr(fd, va_arg(ap, uint64));
     ece:	008b8d13          	addi	s10,s7,8
     ed2:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
     ed6:	03000593          	li	a1,48
     eda:	855a                	mv	a0,s6
     edc:	d37ff0ef          	jal	c12 <putc>
  putc(fd, 'x');
     ee0:	07800593          	li	a1,120
     ee4:	855a                	mv	a0,s6
     ee6:	d2dff0ef          	jal	c12 <putc>
     eea:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     eec:	00000b97          	auipc	s7,0x0
     ef0:	5e4b8b93          	addi	s7,s7,1508 # 14d0 <digits>
     ef4:	03c9d793          	srli	a5,s3,0x3c
     ef8:	97de                	add	a5,a5,s7
     efa:	0007c583          	lbu	a1,0(a5)
     efe:	855a                	mv	a0,s6
     f00:	d13ff0ef          	jal	c12 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
     f04:	0992                	slli	s3,s3,0x4
     f06:	397d                	addiw	s2,s2,-1
     f08:	fe0916e3          	bnez	s2,ef4 <vprintf+0x21c>
        printptr(fd, va_arg(ap, uint64));
     f0c:	8bea                	mv	s7,s10
      state = 0;
     f0e:	4981                	li	s3,0
     f10:	6d02                	ld	s10,0(sp)
     f12:	bd01                	j	d22 <vprintf+0x4a>
        putc(fd, va_arg(ap, uint32));
     f14:	008b8913          	addi	s2,s7,8
     f18:	000bc583          	lbu	a1,0(s7)
     f1c:	855a                	mv	a0,s6
     f1e:	cf5ff0ef          	jal	c12 <putc>
     f22:	8bca                	mv	s7,s2
      state = 0;
     f24:	4981                	li	s3,0
     f26:	bbf5                	j	d22 <vprintf+0x4a>
        if((s = va_arg(ap, char*)) == 0)
     f28:	008b8993          	addi	s3,s7,8
     f2c:	000bb903          	ld	s2,0(s7)
     f30:	00090f63          	beqz	s2,f4e <vprintf+0x276>
        for(; *s; s++)
     f34:	00094583          	lbu	a1,0(s2)
     f38:	c195                	beqz	a1,f5c <vprintf+0x284>
          putc(fd, *s);
     f3a:	855a                	mv	a0,s6
     f3c:	cd7ff0ef          	jal	c12 <putc>
        for(; *s; s++)
     f40:	0905                	addi	s2,s2,1
     f42:	00094583          	lbu	a1,0(s2)
     f46:	f9f5                	bnez	a1,f3a <vprintf+0x262>
        if((s = va_arg(ap, char*)) == 0)
     f48:	8bce                	mv	s7,s3
      state = 0;
     f4a:	4981                	li	s3,0
     f4c:	bbd9                	j	d22 <vprintf+0x4a>
          s = "(null)";
     f4e:	00000917          	auipc	s2,0x0
     f52:	51a90913          	addi	s2,s2,1306 # 1468 <malloc+0x40e>
        for(; *s; s++)
     f56:	02800593          	li	a1,40
     f5a:	b7c5                	j	f3a <vprintf+0x262>
        if((s = va_arg(ap, char*)) == 0)
     f5c:	8bce                	mv	s7,s3
      state = 0;
     f5e:	4981                	li	s3,0
     f60:	b3c9                	j	d22 <vprintf+0x4a>
     f62:	64a6                	ld	s1,72(sp)
     ...
     f72:	60e6                	ld	ra,88(sp)
     f74:	6446                	ld	s0,80(sp)
     f76:	6906                	ld	s2,64(sp)
     f78:	6125                	addi	sp,sp,96
     f7a:	8082                	ret
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ...
     fea:	a02d                	j	1014 <free+0x3c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
     fec:	4618                	lw	a4,8(a2)
     fee:	9f2d                	addw	a4,a4,a1
     ff0:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
     ff4:	6398                	ld	a4,0(a5)
     ff6:	6310                	ld	a2,0(a4)
     ff8:	a83d                	j	1036 <free+0x5e>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
     ffa:	ff852703          	lw	a4,-8(a0)
     ffe:	9f31                	addw	a4,a4,a2
    1000:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    1002:	ff053683          	ld	a3,-16(a0)
    1006:	a091                	j	104a <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    1008:	6398                	ld	a4,0(a5)
    100a:	00e7e463          	bltu	a5,a4,1012 <free+0x3a>
    100e:	00e6ea63          	bltu	a3,a4,1022 <free+0x4a>
{
    1012:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1014:	fed7fae3          	bgeu	a5,a3,1008 <free+0x30>
    1018:	6398                	ld	a4,0(a5)
    101a:	00e6e463          	bltu	a3,a4,1022 <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    101e:	fee7eae3          	bltu	a5,a4,1012 <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    1022:	ff852583          	lw	a1,-8(a0)
    1026:	6390                	ld	a2,0(a5)
    1028:	02059813          	slli	a6,a1,0x20
    102c:	01c85713          	srli	a4,a6,0x1c
    1030:	9736                	add	a4,a4,a3
    1032:	fae60de3          	beq	a2,a4,fec <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
    1036:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    103a:	4790                	lw	a2,8(a5)
    103c:	02061593          	slli	a1,a2,0x20
    1040:	01c5d713          	srli	a4,a1,0x1c
    1044:	973e                	add	a4,a4,a5
    1046:	fae68ae3          	beq	a3,a4,ffa <free+0x22>
    p->s.ptr = bp->s.ptr;
    104a:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    104c:	00001717          	auipc	a4,0x1
    1050:	fcf73223          	sd	a5,-60(a4) # 2010 <freep>
}
    1054:	6422                	ld	s0,8(sp)
    1056:	0141                	addi	sp,sp,16
    1058:	8082                	ret

000000000000105a <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    105a:	7139                	addi	sp,sp,-64
    105c:	fc06                	sd	ra,56(sp)
    105e:	f822                	sd	s0,48(sp)
    1060:	f426                	sd	s1,40(sp)
    1062:	ec4e                	sd	s3,24(sp)
    1064:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    1066:	02051493          	slli	s1,a0,0x20
    106a:	9081                	srli	s1,s1,0x20
    106c:	04bd                	addi	s1,s1,15
    106e:	8091                	srli	s1,s1,0x4
    1070:	0014899b          	addiw	s3,s1,1
    1074:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    1076:	00001517          	auipc	a0,0x1
    107a:	f9a53503          	ld	a0,-102(a0) # 2010 <freep>
    107e:	c915                	beqz	a0,10b2 <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1080:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    1082:	4798                	lw	a4,8(a5)
    1084:	08977a63          	bgeu	a4,s1,1118 <malloc+0xbe>
    1088:	f04a                	sd	s2,32(sp)
    108a:	e852                	sd	s4,16(sp)
    108c:	e456                	sd	s5,8(sp)
    108e:	e05a                	sd	s6,0(sp)
  if(nu < 4096)
    1090:	8a4e                	mv	s4,s3
    1092:	0009871b          	sext.w	a4,s3
    1096:	6685                	lui	a3,0x1
    1098:	00d77363          	bgeu	a4,a3,109e <malloc+0x44>
    109c:	6a05                	lui	s4,0x1
    109e:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    10a2:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    10a6:	00001917          	auipc	s2,0x1
    10aa:	f6a90913          	addi	s2,s2,-150 # 2010 <freep>
  if(p == SBRK_ERROR)
    10ae:	5afd                	li	s5,-1
    10b0:	a081                	j	10f0 <malloc+0x96>
    ...
    10be:	34e78793          	addi	a5,a5,846 # 2408 <base>
    10c2:	00001717          	auipc	a4,0x1
    10c6:	f4f73723          	sd	a5,-178(a4) # 2010 <freep>
    10ca:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    10cc:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    10d0:	b7c1                	j	1090 <malloc+0x36>
        prevp->s.ptr = p->s.ptr;
    10d2:	6398                	ld	a4,0(a5)
    10d4:	e118                	sd	a4,0(a0)
    10d6:	a8a9                	j	1130 <malloc+0xd6>
  hp->s.size = nu;
    10d8:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    10dc:	0541                	addi	a0,a0,16
    10de:	efbff0ef          	jal	fd8 <free>
  return freep;
    10e2:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    10e6:	c12d                	beqz	a0,1148 <malloc+0xee>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    10e8:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    10ea:	4798                	lw	a4,8(a5)
    10ec:	02977263          	bgeu	a4,s1,1110 <malloc+0xb6>
    if(p == freep)
    10f0:	00093703          	ld	a4,0(s2)
    10f4:	853e                	mv	a0,a5
    10f6:	fef719e3          	bne	a4,a5,10e8 <malloc+0x8e>
  p = sbrk(nu * sizeof(Header));
    10fa:	8552                	mv	a0,s4
    10fc:	a43ff0ef          	jal	b3e <sbrk>
  if(p == SBRK_ERROR)
    1100:	fd551ce3          	bne	a0,s5,10d8 <malloc+0x7e>
        return 0;
    1104:	4501                	li	a0,0
    1106:	7902                	ld	s2,32(sp)
    1108:	6a42                	ld	s4,16(sp)
    110a:	6aa2                	ld	s5,8(sp)
    110c:	6b02                	ld	s6,0(sp)
    110e:	a03d                	j	113c <malloc+0xe2>
    1110:	7902                	ld	s2,32(sp)
    1112:	6a42                	ld	s4,16(sp)
    1114:	6aa2                	ld	s5,8(sp)
    1116:	6b02                	ld	s6,0(sp)
      if(p->s.size == nunits)
    1118:	fae48de3          	beq	s1,a4,10d2 <malloc+0x78>
        p->s.size -= nunits;
    111c:	4137073b          	subw	a4,a4,s3
    1120:	c798                	sw	a4,8(a5)
        p += p->s.size;
    1122:	02071693          	slli	a3,a4,0x20
    1126:	01c6d713          	srli	a4,a3,0x1c
    112a:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    112c:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    1130:	00001717          	auipc	a4,0x1
    1134:	eea73023          	sd	a0,-288(a4) # 2010 <freep>
      return (void*)(p + 1);
    1138:	01078513          	addi	a0,a5,16
  }
}
    113c:	70e2                	ld	ra,56(sp)
    113e:	7442                	ld	s0,48(sp)
    1140:	74a2                	ld	s1,40(sp)
    1142:	69e2                	ld	s3,24(sp)
